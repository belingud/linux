...
* 效率 时间观念  团队意识  代码习惯  学习能力  
* 番茄钟  效率
* 时间观念  
  * 每天提前15分钟坐下  迟到的话 平板支撑 或者 群红包   晚上9点45 
  * 团队意识 
  * 代码习惯  注意写注释  pe8 
  * 学习能力  多去逛社区  segmentfault、掘金、v2ex 、github 、码云、coding.net 
...
* 林纳斯 的伟大在于将Linux开源   
  ...
  * git （代码版本管理工具  团队协作开发必备 ）两周 写完了  用c写     最优秀代码版本管理工具 没有之一 
    * 没有网络 也能进行团队协作 
    * 除了git之外 还有svn 版本管理工具  这个必须有网络才可以   这个速度 较git 差了 不止一个档次 
...
```
1.在虚拟机的 浏览器中ps://www.jetbrains.com/pycharm/download/#section=linux  下载Linux 专业版  
2.提取到桌面  
3.进入提取后的目录 
4.继续切换到  bin  
5.在终端打开 
...
```
在虚拟机里 火狐浏览器 pinyin.sogou.com  下载Linux 版  64位  下载下来是deb文件  
找到所在的目录 双击    
系统设置  语言支持  键盘输入法设置为fcitx重启系统  
```
